...
export class AlterForgotPasswordLinkEmailTemplate1722429342058 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        if (existData) {
            const data = `Dear {name},<br><br><p>We've received your request to reset your password.If you wish to change your password please click on the link given below.</p><br><a href= {link}>Click Here</a > <br><p> for reset your password < /p> <p>Regards,</p > <br><p>The Orsetto Commerce Team </p>`;
