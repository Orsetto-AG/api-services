...
<p>Thank you for expressing your interest and signing up as a Seller with Orsetto Cart..</p>
...
`;
            ...
            emailData.subject = ' You just signed-up as a Seller with Orsetto Cart ';
