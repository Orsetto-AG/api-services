    ...
    if (settings) {
        ...
        function data(): void {
            ...
            if (fs.existsSync(dir)) {
                ...
                fs.readFile('dist/src/loaders/orsettoConnectLoader.js', 'utf8', (err1: any, data1: any) => {
                    if (err1) {
                        return console.log(err1);
                    }
                    const orsettoSourcePath = 'path.join(__dirname, ' + "'../../'" + ', ' + "'views')";
                    const orsettoDestPath = 'path.join(__dirname, ' + "'../../../'" + ', ' + "'views')";
                    const result1 = data1.replace(orsettoSourcePath, orsettoDestPath);
                    fs.writeFile('dist/src/loaders/orsettoConnectLoader.js', result1, 'utf8', (err2) => {
